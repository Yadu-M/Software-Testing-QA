...
//    }
    ...
    public void testEqualsMoney() {
    	IMoney x = new MoneyBag();
    	IMoney money = new Money(0, "EURO");
    	
    	assertEquals(true, x.equals(money));
    }
    
    public void testInvalidIMoneyInstance() {
    	MoneyBag moneyBag1 = new MoneyBag();
    	assertFalse(moneyBag1.equals(0));
    }
    
    public void testNotEqualsMoneyBag() {
    	MoneyBag moneyBag1 = new MoneyBag();
    	MoneyBag moneyBag2 = new MoneyBag();
    	moneyBag1.appendMoney(new Money(10, "EURO"));
    	moneyBag1.appendMoney(new Money(15, "CAD"));
    	assertFalse(moneyBag1.equals(moneyBag2));
    }
